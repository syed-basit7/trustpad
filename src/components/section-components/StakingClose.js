    ...
    <>
        <div class="nft-card stake-tab p-4 my-3">
            ...
            <div className='border-bottom  py-2 d-flex align-items-center border-secondary text-white'>
                ...
                <p className='text-end p-0 m-0 w-50'>0 %</p>
            </div>
            <div className='border-bottom  py-2 d-flex align-items-center border-secondary text-white'>
                <h6 className='p-0 m-0 w-50'>REWARD PER MINUTE</h6>
                <p className='text-end p-0 m-0 w-50'>0 SFUND</p>
            </div>
            <div className='border-bottom  py-2 d-flex align-items-center border-secondary text-white'>
            ...
            <div className='border-bottom  py-2 d-flex align-items-center border-secondary text-white'>
                ...
                <p className='text-end p-0 m-0 w-50'>70,000 / 70,000</p>
            </div>
            <div className='mt-4'>
                ...
                <div className='w-100 text-end mt-2'>
                    ...
                    <h6 className='text-warning mt-2 p-0 m-0'>100% Complete</h6>
                </div>
            </div>
